...
const onCreateWebpackConfig = (args, options) => {
    const { apiKey, authDomain, databaseURL, projectId, storageBucket, messagingSenderId, appId, } = options;
    ...
    actions.setWebpackConfig({
        plugins: [
            plugins.define({
                ...
                "process.env.GATSBY_FIREBASE_MESSAGING_SENDER_ID": JSON.stringify(messagingSenderId),
